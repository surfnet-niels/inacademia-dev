...
$servers->setValue('server','name','idp.InAcademia.local LDAP');
...
$servers->setValue('server','base',array('dc=inacademia,dc=local'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=inacademia,dc=local');
